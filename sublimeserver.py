...
class SublimeServerHandler(BaseHTTPRequestHandler):
    ...
    def version_string(self):
        ...
        return 'SublimeServer/%s Sublime/%s' % (python_version, sublime.version())
    ...
    def do_OPTIONS(self):
        ...
        self.send_header('Access-Control-Allow-Methods', 'GET, POST, PUTLocation, OPTIONS')
...
class SublimeserverStarCommand(sublime_plugin.ApplicationCommand):
    def run(self):
        ...
        try:
            ...
            if attempts > settings.get('attempts'):
                ...
                # try another attempt
                sublime.set_timeout(
                    lambda: sublime.run_command('sublimeserver_star'),
